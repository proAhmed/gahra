...
public class GetSingleOffer extends AsyncTask<String, Void, OfferModelMain> {

	private   String URL =  "http://aljahrashop.com/API/ar/offer/i/";
	private ProgressDialog dialog;
	private OnLoadingComplete callback;
	private Context context;

	public GetSingleOffer(Context context, OnLoadingComplete cb,int id) {
