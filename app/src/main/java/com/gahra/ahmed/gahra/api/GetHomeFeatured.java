...
public class GetHomeFeatured extends AsyncTask<String, Void, FeaturedMain> {

	private   String URL =  "http://aljahrashop.com/API/ar/home/featured";
	...
	@Override
	protected FeaturedMain doInBackground(String... params) {
		...
		if (responseJSON != null && responseJSON.length() > 1) {
			...
			gson = gb.create();
			try {
				obj = gson.fromJson(responseJSON, FeaturedMain.class);
	...
	@Override
	protected void onPostExecute(FeaturedMain result) {
		if (dialog.isShowing()) {
			dialog.dismiss();
		}
		if (result != null) {
