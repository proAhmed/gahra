...
public class GetOfferByCompanyId extends AsyncTask<String, Void, OfferModelMain> {

	private   String URL =  "\thttp://aljahrashop.com/API/ar/offer/company/";
	private ProgressDialog dialog;
	private OnLoadingComplete callback;
	private Context context;

	public GetOfferByCompanyId(Context context, OnLoadingComplete cb, int id) {
