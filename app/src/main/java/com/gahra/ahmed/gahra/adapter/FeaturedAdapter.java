 ...
 */
public class FeaturedAdapter extends RecyclerView
    ...
    public FeaturedAdapter(Activity context,ArrayList<FeaturedModel> myDataset,OnRecycleClick onCategoryClick) {
