...
public class GetRelatedOffer extends AsyncTask<String, Void, OfferModelMain> {

	private   String URL =  "http://aljahrashop.com/API/ar/offer/related/";
	private ProgressDialog dialog;
	private OnLoadingComplete callback;
	private Context context;

	public GetRelatedOffer(Context context, OnLoadingComplete cb,int id) {
